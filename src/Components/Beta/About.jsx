...
import { EVENT_NAME, EVENT_NAME_FULL, EVENT_START_TIME } from "betaConstants";
    ...
    return (
      <div id="about" className="bg-primary text-white py-5">
        ...
        <Container>
          <h2>WE GOT YOU</h2>
          <p>
            {" " + EVENT_NAME_FULL} is happening remotely, but don't worry, it
            will still feature snacks, prizes, and swag, delivered to your door!
            {}
          </p>
          <br />
        </Container>
