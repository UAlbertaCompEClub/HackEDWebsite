        ...
        >
          {/* <Grid.Row centered>
            <Grid.Column width={12}>
              <h4>
                The Computer Engineering Club would like to give a special thank
                you to Ada's Team and UACS, without whom {EVENT_NAME} would not
                be possible.
              </h4>
            </Grid.Column>
          </Grid.Row> */}
            ...
            <Grid.Column>
              <List>
                <List.Item
                  icon="linkify"
                  content={
                    <a href="http://www.compeclub.com/">compeclub.com</a>
                  }
                />
                <List.Item
                  icon="mail"
                  content={
                    <a href="mailto:hacked@compeclub.com">
                ...
                <List.Item
                  icon="twitter"
                  content={
                    <a href="https://twitter.com/CompEClub">@CompEClub</a>
                  }
                />
                <List.Item
                  icon="facebook"
                  content={
                    <a href="https://www.facebook.com/compeclub">@CompEClub</a>
                  }
                />
              </List>
            </Grid.Column>
