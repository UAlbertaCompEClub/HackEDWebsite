...
const scheduleItems = [
    ...
    },
    {
        ...
        location: "",
        description: "A quick refresher on python basics and for any questions you might have"
    },
    {
        ...
        icon: 'pencil alternate',
        location: "",
        description: "Highly recommended for anyone who doesn't know git, for working on code collaboratively"
    },
    {
        title: "NumPy/Pandas",
    ...
    },
    {
        ...
        icon: 'pencil alternate',
        location: "",
        description: "Moving data from the internet to your project can be easy with the right tricks"
    },
    // {
    //     title: "Intro to Git",
