    ...
    render() {
        return (
            <div>
                ...
                <HackEDMap/>
                <h4 style={{textAlign: 'center', padding: 50,fontFamily: 'Open Sans'}}>HackED 2025 is a hybrid event! Join us online on discord to get the full experience from anywhere you'd like.</h4>
            </div>
        );
    }
}
